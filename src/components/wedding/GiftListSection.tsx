...
const GiftListSection = () => {
  return (
    <section className="py-16 md:py-24 px-4 bg-background">
      ...
      >
        {/* Section Header */}
        <p className="wedding-subtitle mb-3 tracking-[0.3em]">Com carinho</p>

        <h2 className="wedding-title text-3xl md:text-4xl lg:text-5xl mb-4">
          Lista de Presentes
        </h2>

        <div className="mx-auto w-20 h-[2px] bg-primary/40 mb-12 rounded-full" />
        ...
        <motion.div
          ...
          className="relative bg-white rounded-2xl p-8 md:p-12 shadow-lg border border-border/30 overflow-hidden"
        >
          {/* Background hover */}
          ...
          <div className="relative z-10 flex justify-center">
            <Button
              ...
              className="w-full sm:w-auto px-6 sm:px-8 py-6 text-base md:text-lg bg-primary text-primary-foreground hover:bg-primary/90 transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
            >
